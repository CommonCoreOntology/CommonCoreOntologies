**_This branch contains a version of CCO that uses numeric IRIs. For testing purposes. The mapping file is located [here](https://github.com/CommonCoreOntology/CommonCoreOntologies/blob/numeric-iris/documentation/rename_mapping.csv)._**
---
